 ...
 * 
 * @dtf.tag.desc <p>
 *               This command simulates a mouse up event at the location specified
 ...
 *      <open url="/"/>
 *      <mouseUpAt locator="//input[@value='q']" coordString="0,0"/>
 *  </selenium>
 */
public class Mouseupat extends SeleniumLocatorAtTag {
    
    @Override
    public void execute() throws DTFException {
        getSelenium().mouseUpAt(getLocator(), getCoordString());
    }
}
