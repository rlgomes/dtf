 ...
 * 
 * @dtf.tag.desc The http.put tag is used to generate http.put requests and
 ...
 * @dtf.event http.put
 * @dtf.event.attr data 
 * @dtf.event.attr.desc the http.put data that was sent along with this 
 *                      specific request.
 *
 * @dtf.event http.put
 * @dtf.event.attr datahash 
 * @dtf.event.attr.desc the hash of the http.put data that was sent along with 
 *                      this specific request.
 *
 * @dtf.event http.put
 * @dtf.event.attr body
 * @dtf.event.attr.desc the http.put data that was received along with the 
 *                      HTTP response.
 *                      
 * @dtf.event http.head
 ...
 * @dtf.event.attr.desc the hash of the http.put data that was received along 
 ...
 *                      
 * @dtf.tag.example 
 * <http_put uri="${dtf.http.uri}" perfrun="true" onFailure="fail">
 ...
 */
public class Http_put extends HttpBase {
    
    public Event executeOp() throws DTFException {
        return getOp().executePut(this);
    }
}
